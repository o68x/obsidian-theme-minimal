...
module.exports = function(grunt) {
    grunt.initConfig({
        ...
        concat_css: {
            dist: {
                files: {
                  'obsidian.css': ['src/css/ocx-mod.css', 'src/css/license.css','src/css/main.min.css','src/css/plugin-compatibility.css','src/css/style-settings.css']
                }
            },
            unminified: {
                files: {
                  'Minimal.css': ['src/css/ocx-mod.css', 'src/css/license.css','src/css/main.css','src/css/plugin-compatibility.css','src/css/style-settings.css']
                }
            }
        },
    ...
    grunt.registerTask('default',['env:local','loadconst', 'sass', 'watch']);
}
